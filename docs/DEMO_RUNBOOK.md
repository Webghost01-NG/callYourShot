...
2. Configure the approved public DreamDEX origin in `.env.local`. Use the
   supported injected browser-wallet path; QR pairing is suspended. See
...
### 1:10–1:55 — Verifiable prediction performance
